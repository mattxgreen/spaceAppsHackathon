...
var client = new Twitter({
  consumer_key: 'keys go here',
  consumer_secret: 'keys go here',
  access_token_key: 'keys go here',
  access_token_secret: 'keys go here'
});

var sickPlaces = ['defaul']
var location = ['default']

for(var i = 50; i < 51 ; i++) {
  location = fiftyCities[i].latitude + "," + fiftyCities[i].longitude + ",5mi";
  console.log(location)
  client.get('search/tweets', {q: "i have a cold", geocode: location, count: 1},
    function(error, tweets, response){
      if (tweets.statuses.length > 0) {
        sickPlaces.push(tweets.statuses[0].user.location)
        console.log(sickPlaces)
      }
    }
  );
}

//what was logged to the console from the above function:
